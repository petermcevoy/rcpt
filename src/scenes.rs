    ...
    let scene: Vec<Box<Hitable>> = vec![
        Box::new( //Red
            Plane {
                ...
                width: 555.0,
                height: 555.0,
                material: Some(Arc::new( materials::Lambertian{ emit: rgb_zero, albedo: rgb_refl_red } ) )
            }  
        ),
        Box::new( //Green
            Plane {
                ...
                width: 555.0,
                height: 555.0,
                material: Some(Arc::new( materials::Lambertian{ emit: rgb_zero, albedo: rgb_refl_green } ) )
            }  
        ),
        Box::new( //Light
            Plane {
                ...
                width: 130.0,
                height: 105.0,
                material: Some(Arc::new( materials::Lambertian{ emit: rgb_light, albedo: rgb_zero } ) )
        ...
        Box::new( //White floor
            Plane {
                ...
                width: 555.0,
                height: 555.0,
                material: Some(Arc::new( materials::Lambertian{ emit: rgb_zero, albedo: rgb_refl_white } ) )
            }  
        ),
