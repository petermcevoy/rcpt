...
impl RGBSpectrum {
    ...
    pub fn from_sampled(lambda: &[Real], v: &[Real], n: i32) -> RGBSpectrum {
        ...
        for i in 0..N_CIE_SAMPLES {
            let val: Real = interpolate_spectrum_samples(lambda, v, n, CIE_LAMBDA[i as usize]);
