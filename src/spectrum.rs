...
impl RGBSpectrum {
    ...
    pub fn from_sampled(lambda: &[Real], v: &[Real], n: usize) -> RGBSpectrum {
        ...
        for i in 0..N_CIE_SAMPLES {
            let val: Real = interpolate_spectrum_samples(lambda, v, n as i32, CIE_LAMBDA[i as usize]);
...
lazy_static! {
    pub static ref ILLUMINATION_D50: Spectrum = { 
        print!("D50 illum:"); Spectrum::from_sampled(&CIE_D50_LAMBDA, &CIE_D50_VALUES, CIE_D50_N_SAMPLES)
    };
    pub static ref ILLUMINATION_D65: Spectrum = { 
        print!("D65 illum:"); Spectrum::from_sampled(&CIE_D65_LAMBDA, &CIE_D65_VALUES, CIE_D65_N_SAMPLES)
    };
    pub static ref ILLUMINATION_HALOGEN: Spectrum = { 
        print!("HALOGEN illum:"); Spectrum::from_sampled(&HALOGEN_LAMBDA, &HALOGEN_VALUES, HALOGEN_N_SAMPLES)
    };
}
